"""
Django settings for MonaApps_Project project.
...
INSTALLED_APPS = [
    ...
    "MonaAppsInfluxDB.apps.MonaappsinfluxdbConfig",
]
...
ROOT_URLCONF = 'MonaApps_Project.urls'
...
EMAIL_PORT = 2525
EMAIL_USE_TLS = True
DEFAULT_FROM_EMAIL = env('SMTP_FROM')
